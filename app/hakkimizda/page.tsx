  ...
  return (
    <main className="bg-[#f6f3ed] text-[#101010]">
      ...
      <section className="bg-white px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto grid max-w-[1440px] items-start gap-16 lg:grid-cols-2 lg:gap-20">
          <div className="relative">
            <div className="relative min-h-[430px] overflow-hidden rounded-md bg-[#2e332e] sm:min-h-[560px] lg:min-h-[680px]">
              <Image
                src={publicPath("/images/about.jpg")}
                alt="Umut Group"
                fill
                priority
            ...
            <div className="absolute bottom-5 right-5 rounded-md bg-[#d1ad43] px-8 py-6 text-white shadow-2xl sm:bottom-[-34px] sm:right-[-20px] sm:px-10 sm:py-8">
          ...
          <div className="pt-4">
            <div className="mb-7 flex items-center gap-4 font-body text-sm tracking-[0.35em] text-[#c9a84c] sm:tracking-[0.45em]">
              <span className="h-px w-10 bg-[#c9a84c]" />
              UMUT GROUP
            </div>

            <h2 className="font-display text-[clamp(2.7rem,5vw,5rem)] font-semibold leading-[1.02]">
            ...
            <div className="mt-9 space-y-5 font-body text-[18px] leading-8 text-[#3d3d3d]">
              <p>
                ...
                İstanbul Silivri&apos;de seçkin gayrimenkul yatırımlarına yön
                veren güçlü bir markadır.
              </p>
              ...
              <p>
                Bizim için gayrimenkul yalnızca bir yapı değil, doğru planlanmış
                ve modeller birbiriyle değer bulacak bir değer ve güven
                mirasıdır.
              </p>
            ...
            <div className="mt-8 space-y-5 font-body text-[18px] leading-8 text-[#3d3d3d]">
              <p>
                Sürekli yatırımcılarımızı doğru lokasyon, doğru zaman ve doğru
                proje ile buluşturuyoruz.
              </p>

              <p>
                Her projede; estetik, kalite ve sürdürülebilir kazanç ilkelerini
                esas alıyoruz. Sürecin ilk adımından teslim aşamasına kadar tüm
                detayları profesyonel bir titizlikle yönetiyoruz.
              </p>

              <p>
                UMUT GROUP olarak amacımız yalnızca satış yapmak değil,
                yatırımcılarımıza değer kazandırarak güçlü bir gelecek inşa
                etmektir.
              </p>

              <p>
                Eğer siz de güvenilir, prestijli ve kazançlı bir yatırım
                arıyorsanız; doğru yerdesiniz.
              </p>

              <p className="font-display text-xl italic text-[#c9a84c]">
                Geleceğe umutla, güvenle ve sağlam adımlarla ilerleyin. UMUT
                GROUP yanınızdır.
              </p>
            </div>
